...
public class AStarDiv_999298402_998848125 implements AIModule {

    private double getGValue(HashMap<Point, Double> gValues, Point pt) {
    ...
    private double getFValue(HashMap<Point, Double> fValues, Point pt) {
